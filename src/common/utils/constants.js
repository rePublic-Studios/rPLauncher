...
export const GDL_LEGACYJAVAFIXER_MOD_URL =
  'https://rp.tribbe.de/legacyjavafixer-1.0.jar';
export const MOJANG_APIS = 'https://authserver.mojang.com';
export const ELYBY_APIS = 'https://authserver.ely.by/auth';
export const JAVA_MANIFEST_URL = 'https://cdn.tribbe.de/openjdk8.json';
export const JAVA16_MANIFEST_URL = 'https://cdn.tribbe.de/openjdk16.json';
...
export const FMLLIBS_OUR_BASE_URL = 'https://fmllibs.tribbe.de';
