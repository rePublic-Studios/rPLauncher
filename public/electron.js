...
if (!app.isDefaultProtocolClient('rplauncher')) {
  app.setAsDefaultProtocolClient('rplauncher');
}
...
app.setPath('userData', path.join(app.getPath('appData'), 'rplauncher'));
...
function createWindow() {
  ...
  mainWindow.webContents.session.webRequest.onBeforeSendHeaders(
    (details, callback) => {
      ...
      if (xSkipOrigin !== 'skip') {
        requestHeaders.Origin = 'https://rp.tribbe.dev';
      }
